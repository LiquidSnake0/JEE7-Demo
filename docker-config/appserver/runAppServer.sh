...
docker run --ip="172.18.0.2" --net="jee7-network" -d  -p 18080:8080 -p 19990:9990 -p 18787:8787 -v "/tmp/docker-deploy:/opt/jboss/wildfly/standalone/deployments/:rw" jee7-demo-wildfly
